...
class CGrayscale : public RuntimeClass<RuntimeClassFlags<RuntimeClassType::WinRtClassicComMix>, ABI::Windows::Media::IMediaExtension, IMFTransform>
{
...
public:
    ...
    STDMETHODIMP GetStreamIDs(DWORD dwInpoutIDArraySize, DWORD* pdwInputIDs, DWORD dwOutputIDArraySize, DWORD* pdwOutputIDs);
